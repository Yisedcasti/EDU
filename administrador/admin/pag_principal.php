        ...
        <div id="page-content-wrapper">
            ...
            <section class="col">
                <div class="card h-100">
                    ...
                    <div class="card-footer text-center contenedor">
                        <a href="../php/registro/profesor/view/registro_profesor.php" class="btn btn-dark">Registros</a>
                    </div>
                </div>
            </section>
            ...
            <section class="col">
                <div class="card h-100">
                    ...
                    <div class="card-footer text-center contenedor">
                        <a href="../php/registro/estudiantes/view/registro_estudiante.php"" class="btn btn-dark">Regsitros</a>
                    </div>
                </div>
            </section>
